...
int main(){
	cout<<"\nWelcome to Indian Railways:"<<endl;
...
//Classes, Objects, Constructors, Destructors
	...
	cout<<"Enter Details for Antyodaya:"<<endl;
...
//Function Overloading
	cout<<endl;
	cout<<"\nPassenger Details and Berth Reservation:"<<endl;
        ticket t1;
	int age,ch;
	string name,type;
	int PID=6072;
...
//Operator Overloading
	cout<<"\nCalculating and Displaying Total Amount for Two Tickets:"<<endl;
	booking aashin("6072"),ap("6000");
	aashin.getch();
	aashin.setcost();
	--aashin;
	aashin.display();
...
//Single Inheritance
	...
	cout<<endl;
//Multilevel Inheritance
	cout<<"\nPlatform, Station and Zone Details:"<<endl;
	int pf;
	cin.ignore();
	cout<<endl;
	cout<<"Enter Station Name:";
	...
	cout<<endl;
//Multiple Inheritance
	cout<<"\nZonal Region Details:"<<endl;
	ZonalRegion myRailway("Southern", "MGR Chennai Central");
	myRailway.displaySystem();
	cout<<endl;
//Hierarchical Inheritance
	cout<<"\nEmployee Details:"<<endl;
	Vehicle myVehicle("Vande Bharat");
	Stations myStation("MGR Central Station");
	Employee myEmployee("Aashin");
...
//Multipath Inheritance
	...
	ticket.displayStation();
        cout << endl;
//Hybrid Inheritance
	cout<<"\nMaintenance Crew Details:"<<endl;
	MaintenanceCrew maintenancePerson("Mr. XYZ", "Maintenance Vehicle");
...
//Function Template
	cout<<endl;
	cout<<"\nDisplaying required details as requested by user:"<<endl;
	int tno,pid;
...
//Class Template
	cout<<endl;
	cout<<"\nTicket Details Printed:"<<endl;
        tickets <int,int> obj1;
        tickets <string,string> obj2;
        obj1.setdata(12634,6072);
